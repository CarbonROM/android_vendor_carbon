...
# Set Carbon version
ifdef CARBON_RELEASE
    STELIX_VERSION := "STELIX-LP5.1-v"$(STELIX_VERSION_MAJOR).$(STELIX_VERSION_MINOR)
else
    STELIX_VERSION := "STELIX-LP5.1-$(CARBON_BUILDTYPE)"-$(shell date +%Y%m%d-%H%M)
endif
