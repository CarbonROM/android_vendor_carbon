...
# Set Carbon version
ifdef CARBON_RELEASE
    CARBON_VERSION := "CARBON_"$(CARBON_VERSION_MAJOR).$(CARBON_VERSION_MINOR)-$(CARBON_BUILDTYPE)-$(shell date +%Y%m%d-%H%M)
else
    CARBON_VERSION := "CARBON_"$(CARBON_VERSION_MAJOR)-$(CARBON_BUILDTYPE)-$(shell date +%Y%m%d-%H%M)
endif
