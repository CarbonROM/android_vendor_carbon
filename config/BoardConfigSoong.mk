...
SOONG_CONFIG_carbonGlobalVars_target_uses_qml := $(TARGET_USES_QML)
SOONG_CONFIG_carbonGlobalVars_target_uses_eigen := $(if $(strip $(TARGET_USES_QML)),false,true)
...
SOONG_CONFIG_carbonQcomVars_uses_qcom_bsp_legacy := $(TARGET_USES_QCOM_BSP_LEGACY)
...
SOONG_CONFIG_carbonGlobalVars_target_surfaceflinger_fod_lib := $(TARGET_SURFACEFLINGER_FOD_LIB)
