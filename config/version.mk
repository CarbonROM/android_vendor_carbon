...
ifeq ($(CARBON_BUILDTYPE), RELEASE)
  CARBON_VERSION := $(CARBON_CODENAME)-$(CARBON_REVISION)-$(TARGET_PRODUCT_SHORT)-$(BUILD_ID)-$(shell date -u +%Y%m%d-%H%M)
else
  CARBON_VERSION := $(CARBON_REVISION)-$(CARBON_CODENAME)-$(CARBON_BUILDTYPE)-$(TARGET_PRODUCT_SHORT)-$(BUILD_ID)-$(shell date -u +%Y%m%d-%H%M)
endif
